...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/tenant/storage/google/callback").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/tenant").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/public/tenant-logo/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedHeaders(List.of("Authorization", "Content-Type", "X-Tenant-Id", "Accept"));
